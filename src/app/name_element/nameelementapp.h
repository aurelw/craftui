...
class NameElementApp : public OpenNiInterfaceConnection {

    public:

        typedef typename OpenNiInterface::Cloud Cloud;

        NameElementApp(const OpenNiInterface::Ptr& oniif,
            ...
            withViewer(with3DUI)
        {
            ...
            if (withViewer) {
                ...
                viewer->registerKeyboardCallback(
                        &NameElementApp::viewerKeyboardCallback, *this);
            }
    ...
    private:
        ...
        void queryElementName(const Element::Ptr& element);
