...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/cmake/vtk-5.10")
    else()
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/vtk-5.10")
    endif()
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/aurel/devel/pcl/pcl")
...
set(pcl_all_components  common octree kdtree search sample_consensus filters io 2d features registration geometry visualization outofcore stereo ml keypoints surface segmentation tracking recognition )
